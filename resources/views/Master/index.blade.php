...
@section('JS')
    <script>
        ...
        $(document).on('click', '#btnTambah' , function(e){
            ...
            console.log("fsdfdsf");
            var baseurl = '{{ url('/')}}';
            $.get(baseurl+'/master/sepatu2Add', function(data){
        ...
        $(document).on('click', '#btnSave', function(e) {
            var isvalidate = $("#formAddSepatu2")[0].checkValidity();

            if (isvalidate) {
                e.preventDefault();
                var formData = new FormData($("#formAddSepatu2")[0]); // khusus form dengan file upload
        ...
        function tabelIndex() {
            var baseurl = '{{ url('/')}}';
            $.get(baseurl+'/master/tabelIndex', function(data){
                $('#div1').html(data);
                $('#div2').hide();
                $('#div3').hide();
                $('#div1').show()
        ...
        $(document).on('click', '.btnhapus', function(e) {
            ...
            if (confirm("Yakin Anda Ingin Menghapus Data !")) {
                ...
                var baseurl = '{{ url('/') }}';
                $.get(baseurl + '/master/sepatu2delete_' + kodedel, function(data) {
                    tabelIndex();
                });
